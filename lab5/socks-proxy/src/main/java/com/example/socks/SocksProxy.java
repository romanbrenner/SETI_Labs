...
/**
 * Однопоточный SOCKS5-прокси на неблокирующих сокетах с неблокирующим DNS (dnsjava).
 */
public class SocksProxy {
    ...
    public SocksProxy(int port) throws IOException {
        ...
        // Рекурсивный резолвер — Google DNS
    ...
    private void handleDnsRead() throws IOException {
        ...
        try {
            ...
            if (ipv4 == null) {
                session.failConnect((byte) 0x04); // host unreachable
            } else {
